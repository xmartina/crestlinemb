                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text"  name="stock_title" class="form-control" id="" placeholder="<?php $row['stock_title'] ?>" value="<?php $row['stock_title'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <select name="stock_status" id="" class="form-control basic" value="<?php echo $stock_status; ?>">
                                                    <option selected="selected" disabled><?php echo $stock_status; ?></option>
