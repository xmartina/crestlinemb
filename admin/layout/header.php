    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="compactSidebar">
            <ul class="menu-categories">
                ...
                <li class="menu">
                    <a href="#stock_investment" data-active="false" class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart"><!-- https://feathericons.dev/?search=pie-chart&iconset=feather -->
        ...
        <div id="compact_submenuSidebar" class="submenu-sidebar">
            ...
            <div class="submenu" id="stock_investment">
                <ul class="submenu-list" data-parent-element="#users">
                    <li>
                        <a href="./create_stock.php"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg></span> Create Stock Plan </a>
                    </li>
                    <li>
                        <a href="./list_stock.php"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg></span> List All Stocks </a>
                    </li>
