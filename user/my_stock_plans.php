            ...
            <div class="layout-top-spacing">
                ...
                <div class="bg-white py-2 px-3 rounded-2 mb-1">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 font-weight-bold mb-sm-2 mb-md-2"> <span class="d-lg-none d-xl-none d-md-block d-sm-block mr-2">Plan Name</span> Plan Name</div>
                        <div class="col-lg-2 col-md-6 col-sm-12 mb-sm-2 mb-md-2"> <span class="d-lg-none d-xl-none d-md-block d-sm-block mr-2">Plan Duration</span> Plans Duration</div>
                        <div class="col-lg-2 col-md-6 col-sm-12 mb-sm-2 mb-md-2 font-weight-bold"><span class="d-lg-none d-xl-none d-md-block d-sm-block mr-2">Plan Returns</span> Plan Returns</div>
                        <div class="col-lg-1 col-md-6 col-sm-12 mb-sm-2 mb-md-2"> <span class="d-lg-none d-xl-none d-md-block d-sm-block mr-2">Status</span> Plan Status</div>
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-sm-2 mb-md-2 font-weight-bold"> <span class="d-lg-none d-xl-none d-md-block d-sm-block mr-2">Reference No</span> Plan Reference No</div>
                    </div>
                </div>
            </div>
        </div>
