                        ...
                        <div class="row gx-3 gy-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="text-center plan_main_bg rounded shadow-sm">
                                    ...
                                    <div class="h6 mb-2"><span class="material-symbols-outlined text-success mr-2">done</span> Min : USD<?= $row['stock_amount_min'] ?></div>
                                    <div class="h6 mb-2"><span class="material-symbols-outlined text-success mr-2">done</span> Max : USD<?= $row['stock_amount_max'] ?></div>
                                    <div class="py-3"></div>
